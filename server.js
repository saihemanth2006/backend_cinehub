...
// Ensure uploads directory exists (use /tmp on Vercel since root is read-only)
...
try {
  ...
  console.warn('Could not create uploads directory (might be read-only on Vercel):', e.message);
}
